    ...
    print(f'''{Fore.YELLOW}
                     ...
                     |----------------------------------------------------------------------------------------|
                      ᴜꜱᴇ ᴀᴛ ʏᴏᴜʀ ᴏᴡɴ ʀɪꜱᴋ ! ! !                                    𝒞𝓇ℯ𝒶𝓉ℯ𝒹 ℬ𝓎 : 𝒵-𝒫𝒶𝓉𝒾ℯ𝓃𝒸ℯ
                       ...
                       {Fore.RED}LSD SELFBOT v{SELFBOT.__version__} | {Fore.BLUE}Logged in as: {LSD.user.name}#{LSD.user.discriminator} {Fore.CYAN}| ID: {Fore.CYAN}{LSD.user.id}   
                       {Fore.RED}Nitro Sniper | {Fore.GREEN}{nitro}
...
async def on_member_join(member):
    if LSD.antiraid is True and member.bot:
        try:
            guild = member.guild
...
async def play(ctx, *, query):
    ...
    voice = get(LSD.voice_clients, guild=ctx.guild)
